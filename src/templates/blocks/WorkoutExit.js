...
class WorkoutExit extends Component {
  ...
  render() {
              ...
              <div className="panel end-workout">
                <div className="panel-body">
                  <p className="title align-center">
                    Votre entraînement est terminé ? Félicitations !
                  </p>
                  {!this.props.changedRoutine && !this.props.upgradeRoutine ? (
                    <i className="fa fa-thumbs-up large-icon" />
                  ) : (
                    false
                  )}
                  {this.props.changedRoutine ? (
                    <div className="interaction">
                      <p>
                        Vous avez changé certains poids pour cet entrainement,
                  ...
                  {this.props.upgradeRoutine ? (
                    <div className="interaction">
                      <p>
                        Vous avez atteint vos objectifs ! <br />Souhaitez-vous
                        augmenter la difficulté de cet entrainement ?
                      </p>
                      {updates}
                    </div>
                  ) : (
    ...
    return (
      <div className={'popin visible ' + this.state.animate}>{contents}</div>
    );
  }
}
