      ...
      <nav id="mainNav" className={this.props.menu.status === "opened" ? "active" : "inactive"}>
        <div className="container-fluid navbar-header ">
          <div className="container">
            ...
            <ul className={this.props.menu.workouts === "closed" ? "list" : "list w-workouts"}>
              <li>
              ...
              <li className="middle">
                <button className="trigger" onClick={this.props.triggerWorkoutWindow}>
                  <FontAwesomeIcon icon={['far', 'play']} size="1x" />
                  <FontAwesomeIcon icon={['far', 'times']} size="1x" className="alternate"/>
                </button>
              </li>
              <li>
        ...
        <RoutineLauncherModal routinesList={this.props.routines.routines} exercises={this.props.exercises.list} menu={this.props.menu} closeModal={this.props.triggerWorkoutWindow}/>
