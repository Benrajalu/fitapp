...
class Routines extends Component {
  render() {
    ...
    const routineItems = routineList.map((value, index) => 
      <RoutineDetail key={value.id} closeModal={this.props.closeModal} contents={value} exercisesDatabase={exercisesDatabase} editable={this.props.editable} user={this.props.user} refresh={this.props.refresh} delay={index * 100}
      />
    );
