...
class ExercisePickerPick extends Component {
  render() {
    ...
    return (
      <button className="btn btn-primary exercise-pick" onClick={this.props.handleClick.bind(this, this.props.currentExercise.exerciseId)}>{realExercice ? realExercice.name : false}</button> 
    )
  }
}
